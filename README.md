...
- `B_2`: The amount of byte offset to start reading the value from.
    - For example, if you read with an offset of 01, you'll read the green value and onward. An offset of 03 or more will read from the next pixel(s).
